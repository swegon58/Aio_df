...
export const MessageContent = ({
  ...
  <div
    className={cn(
      "is-user:dark message-bubble flex w-fit max-w-full min-w-0 flex-col gap-2 overflow-visible",
      ...
      "group-[.is-assistant]:overflow-hidden group-[.is-assistant]:text-foreground group-[.is-assistant]:mr-auto group-[.is-assistant]:rounded-lg group-[.is-assistant]:px-4 group-[.is-assistant]:py-3",
      className,
    )}
    {...props}
  >
