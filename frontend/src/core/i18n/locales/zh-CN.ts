...
export const zhCN: Translations = {
  ...
  welcome: {
    greeting: "你好，欢迎回来！",
    description:
      "欢迎使用 Aio，你的个人 AI 智能体。通过内置和自定义的 Skills，\nAio 可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n图片、视频、播客及网页等，几乎可以做任何事情。",

    createYourOwnSkill: "创建你自己的 Agent SKill",
    createYourOwnSkillDescription:
      "创建你的 Agent Skill 来释放 Aio 的潜力。通过自定义技能，Aio\n可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n网页等作品，几乎可以做任何事情。",
  },
  ...
  inputBox: {
    ...
    mode: "模式",
    flashMode: "Aio 轻速版",
    flashModeDescription: "快速轻量，适合日常问题",
    reasoningMode: "思考",
    reasoningModeDescription: "思考后再行动，在时间与准确性之间取得平衡",
    proMode: "Aio 专业版",
    proModeDescription: "更深入的推理，适合复杂高难度问题",
    ultraMode: "Ultra",
  ...
  agents: {
    ...
    agentCreatedPendingRefresh:
      "智能体已创建，但 Aio 暂时还无法读取到它。请稍后刷新当前页面。",
    more: "更多操作",
    agentCreated: "智能体已创建！",
    startChatting: "开始对话",
  ...
  // Workspace
  workspace: {
    officialWebsite: "访问 Aio 官方网站",
    githubTooltip: "访问 Aio 的 Github 仓库",
    settingsAndMore: "设置和更多",
    visitGithub: "在 Github 上查看 Aio",
    reportIssue: "报告问题",
    contactUs: "联系我们",
    about: "关于 Aio",
    logout: "退出登录",
  ...
  channels: {
    ...
    saveChanges: "保存修改",
    descriptions: {
      telegram: "通过 Aio Bot 接收 Telegram 私聊消息。",
      slack: "接收 Slack 工作区消息和提及。",
      discord: "通过 Aio Bot 接收 Discord 服务器消息。",
      feishu: "通过 Aio 应用接收飞书和 Lark 消息。",
      dingtalk: "通过 Aio Bot 接收钉钉 Stream Push 消息。",
      wechat: "通过 Aio Bot 接收微信 iLink 消息。",
      wecom: "通过 Aio AI Bot 接收企业微信消息。",
    },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "安装技能并使其可在 Aio 中使用",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription: "使用键盘快捷键更快地操作 Aio。",
  ...
  settings: {
    title: "设置",
    description: "根据你的偏好调整 Aio 的界面和行为。",
    sections: {
      account: "账号",
      appearance: "外观",
      channels: "渠道",
    ...
    memory: {
      title: "记忆",
      description:
        "Aio 会在后台不断从你的对话中自动学习。这些记忆能帮助 Aio 更好地理解你，并提供更个性化的体验。",
      empty: "暂无可展示的记忆数据。",
      rawJson: "原始 JSON",
      exportButton: "导出记忆",
      exportSuccess: "记忆已导出",
    ...
    appearance: {
      ...
      accentTitle: "主题色",
      accentDescription: "选择用于按钮和链接的强调色。",
      accentDefault: "默认",
      languageTitle: "语言",
    ...
    channels: {
      title: "渠道",
      description: "连接可在浏览器外向 Aio 发送消息的即时通讯账号。",
      disabled:
    ...
    skills: {
      ...
      emptyTitle: "还没有技能",
      emptyDescription:
        "将你的 Agent Skill 文件夹放在 Aio 根目录下的 `/skills/custom` 文件夹中。",
      emptyButton: "创建你的第一个技能",
    },
    notification: {
      title: "通知",
      description:
        "Aio 只会在窗口不活跃时发送完成通知，特别适合长时间任务：你可以先去做别的事，完成后会收到提醒。",
    ...
    account: {
      ...
      ssoPasswordMessage:
        "此账号通过 {provider} 登录，Aio 无法在此管理或修改密码。请前往你的 SSO 提供商账号设置中进行操作。",
