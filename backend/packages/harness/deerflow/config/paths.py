...
class Paths:
    ...
    def user_growth_memory_file(self, user_id: str) -> Path:
        """Per-user growth-memory entries file: `{base_dir}/users/{user_id}/growth_memory.json`."""
        return self.user_dir(user_id) / "growth_memory.json"
